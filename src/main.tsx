...
const interests = ["웹 개발", "어플 개발", "정보통신", "IoT"];
    ...
    <div className="app">
      ...
      <main>
        ...
        <section id="profile" className="profile animate-on-scroll">
          ...
          <p className="section-subtitle">저의 기술 스택과 경력, 관심 분야를 소개합니다.</p>
          <div className="profile-content">
            <div className="profile-section">
              <h3 className="profile-subtitle"><span className="icon">⚡</span> 기술 스택</h3>
            ...
            <div className="profile-section">
              <h3 className="profile-subtitle"><span className="icon">📚</span> 경력 및 교육</h3>
            ...
            <div className="profile-section">
              <h3 className="profile-subtitle"><span className="icon">🎯</span> 관심 분야</h3>
        ...
        <div className="projects-bg">
          <section id="projects" className="animate-on-scroll">
            ...
            <p className="section-subtitle">직접 기획하고 개발한 프로젝트들입니다.</p>
            <div className="projects-grid">
              {projects.map((project, index) => (
                <div key={index} className={`project-card ${project.isComingSoon ? 'coming-soon' : ''}`}>
                  <div className="project-card-front">
                    <span className="project-title-emoji">{project.emoji}</span>
                  ...
                  <div className="project-card-back">
                    ...
                    {!project.isComingSoon && (
                      <div className="project-links">
                        ...
                        {project.pdf && (
                          <a href={project.pdf} target="_blank" rel="noopener noreferrer">발표 자료 ↗</a>
                        )}
                      </div>
                    )}
                  </div>
